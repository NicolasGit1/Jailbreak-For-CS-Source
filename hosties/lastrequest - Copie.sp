...
CleanupLastRequest(loser, arrayIndex)
{
	...
	// TESTI
						...
						//	LR_Player_Prisoner
			// 1349.866088 -9917.430664 104.975288 vs 1356.962280 -8118.500000 116.566261
// -0.930115 93.637702 0.000000 vs 2.645785 -87.275169 0.000000
// paper !setpos 255.333511 -9005.936523 485.062683
new String:Name[32];
			GetCurrentMap(Name, sizeof(Name));
			
			if(StrEqual("jb_paper_alive_ultime_se", Name, true))
			{
			new Float:ang3[3];
		ang3[0] = 0.662190;
		ang3[1] = -89.728126;
		ang3[2] = 0.000000;
			...
			arrg3[2] = 485.062683;	
			damadama = false;
			TeleportEntity(LR_Player_Guard, arrg3, ang3, NULL_VECTOR);		
			TeleportEntity(LR_Player_Prisoner, arrg3, ang3, NULL_VECTOR);
	}
...
InitializeGame(iPartnersIndex)
{
	...
	switch (selection)
	{
		case LR_KnifeFight:
		{
			...
			TeleportEntity(LR_Player_Guard, arrg, ang, NULL_VECTOR);
			...
			TeleportEntity(LR_Player_Prisoner, arrg1, ang1, NULL_VECTOR);
			}
			...
			if(StrEqual("jb_paper_alive_ultime_se", Name, true))
			{
					...
					new Float:arrg5[3];
					arrg5[0] = -672.938964;
					arrg5[1] = -8387.5166014;
					arrg5[2] = 368.426208;	

					TeleportEntity(LR_Player_Guard, arrg5, ang5, NULL_VECTOR);
					...
					TeleportEntity(LR_Player_Prisoner, arrg6, ang6, NULL_VECTOR);
		...
		case LR_GunToss:
		{
			...
			if(StrEqual("jb_paper_alive_ultime_se", Name, true))
			{
					...
					TeleportEntity(LR_Player_Guard, arrg5, ang5, NULL_VECTOR);						
					TeleportEntity(LR_Player_Prisoner, arrg5, ang5, NULL_VECTOR);
			}
...
stock Trail_Remove(client, LRIndex)
{
